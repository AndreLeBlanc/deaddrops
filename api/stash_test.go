...
func TestRemoveStashFile(t *testing.T) {
	files := []StashFile{}
	files = append(files, StashFile{Id: 1, Fname: "test1", Size: 0, Type: "", Download: 1})
	files = append(files, StashFile{Id: 2, Fname: "test2", Size: 0, Type: "", Download: 2})
	files = append(files, StashFile{Id: 3, Fname: "test3", Size: 0, Type: "", Download: 3})
	s := NewEmptyStash()
	s.Files = files
	s.RemoveFile(0)
	if s.FindFileInStash(StashFile{Id: 1, Fname: "test1", Size: 0, Type: "", Download: 1}) != -1 {
	...
	s.Files = files
	s.RemoveFile(1)
	if s.FindFileInStash(StashFile{Id: 2, Fname: "test2", Size: 0, Type: "", Download: 2}) != -1 {
	...
	s.Files = files
	s.RemoveFile(2)
	if s.FindFileInStash(StashFile{Id: 3, Fname: "test3", Size: 0, Type: "", Download: 3}) != -1 {
